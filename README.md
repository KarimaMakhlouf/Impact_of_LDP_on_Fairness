...
Differential Privacy on Fairness. [Preprint](https://arxiv.org/abs/2312.04404) on Arxiv.

(Here the link to the arxiv needs to be added and the bibtex for citation).
